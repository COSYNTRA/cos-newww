...
// import { ArrowRight, Code, Smartphone, Brain, Cloud, Radio, CheckCircle, Star, ChevronDown } from 'lucide-react';
...
//       description: 'Responsive, intuitive applications that deliver exceptional user experiences across all devices.',
...
//       icon: Cloud,
//       title: 'Cloud & DevOps',
//       description: 'Scalable infrastructure and automated workflows for seamless deployment and operations.',
//       gradient: 'from-[#2563EB] to-[#06B6D4]',
//     },
//     {
//       icon: Radio,
//       title: 'IoT Integration',
//       description: 'Connect your devices and systems to create smart, interconnected ecosystems.',
...
//       description: 'AI-powered patient management system serving 50,000+ users',
...
//       image: 'https://images.unsplash.com/photo-1645839078449-124db8a049fd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0ZWNobm9sb2d5JTIwbmV0d29yayUyMGRpZ2l0YWx8ZW58MXx8fHwxNzYwNTk3NTYzfDA&ixlib=rb-4.1.0&q=80&w=1080',
...
//       quote: 'COSYNTRA transformed our vision into reality. Their technical expertise and commitment to excellence is unmatched.',
//     },
//     {
//       name: 'Olivia Chen',
//       role: 'Founder, HealthFirst',
//       image: '/Olivia_Chen.webp',
//       quote: 'Working with COSYNTRA was seamless. They delivered a robust, scalable solution that exceeded our expectations.',
//     },
//     {
//       name: 'Michel Rud',
//       role: 'Project Manager, Volcano',
//       image: '/Michel Rud.webp',
//       quote: 'Partnering with COSYNTRA was an excellent experience. Their team was highly professional, responsive, and delivered a high-quality, future-ready solution right on time.',
//     },
//   ];
...
//             className="absolute top-20 right-20 w-96 h-96 bg-[#2563EB]/5 rounded-full blur-3xl"
//           />
//           <motion.div
//             animate={{
//               scale: [1, 1.3, 1],
...
//             className="absolute bottom-20 left-20 w-96 h-96 bg-[#06B6D4]/5 rounded-full blur-3xl"
//           />
//           {/* Floating particles */}
//           {[...Array(20)].map((_, i) => (
//             <motion.div
//               key={i}
//               className="absolute w-2 h-2 bg-[#2563EB]/20 rounded-full"
//               style={{
...
//               >
//                 <span className="text-[#2563EB] text-sm">🚀 Innovating the Future</span>
//               </motion.div>
//               <h1 className="text-4xl lg:text-6xl text-[#1F2937] leading-tight">
//                 <motion.span
...
//                   className="bg-gradient-to-r from-[#2563EB] to-[#06B6D4] bg-clip-text text-transparent inline-block"
//                 >
//                   Smart Technology
//                 </motion.span>
//               </h1>
...
//               >
//                 COSYNTRA builds intelligent, scalable software solutions that drive business transformation and accelerate your digital journey.
//               </motion.p>
//               <motion.div
//                 initial={{ opacity: 0, y: 20 }}
//                 animate={{ opacity: 1, y: 0 }}
...
//                   className="bg-gradient-to-r from-[#2563EB] to-[#1E3A8A] hover:shadow-xl hover:shadow-[#2563EB]/30 transition-all duration-300 group"
//                 >
//                   Let's Talk
...
//                   variant="outline"
//                   className="border-2 border-[#2563EB] text-[#2563EB] hover:bg-[#2563EB]/5"
//                 >
//                   Explore Services
//                 </Button>
//               </motion.div>
...
//               >
//                 <div>
//                   <div className="text-3xl text-[#2563EB]"><AnimatedCounter value="150+" /></div>
//                   <div className="text-sm text-gray-600">Projects Delivered</div>
//                 </div>
//                 <div>
//                   <div className="text-3xl text-[#2563EB]"><AnimatedCounter value="30+" /></div>
//                   <div className="text-sm text-gray-600">Happy Clients</div>
//                 </div>
//                 <div>
//                   <div className="text-3xl text-[#2563EB]"><AnimatedCounter value="99%" /></div>
...
//                 >
//                   <ImageWithFallback
//                     src="https://images.unsplash.com/photo-1645839078449-124db8a049fd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0ZWNobm9sb2d5JTIwbmV0d29yayUyMGRpZ2l0YWx8ZW58MXx8fHwxNzYwNTk3NTYzfDA&ixlib=rb-4.1.0&q=80&w=1080"
...
//                 className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br from-[#F97316] to-[#2563EB] rounded-2xl opacity-20 blur-xl"
//               />
//               <motion.div
//                 animate={{ y: [0, 20, 0], rotate: [0, -5, 0] }}
//                 transition={{ duration: 4, repeat: Infinity }}
//                 className="absolute -bottom-4 -left-4 w-32 h-32 bg-gradient-to-br from-[#06B6D4] to-[#2563EB] rounded-2xl opacity-20 blur-xl"
//               />
//             </motion.div>
//           </div>
//         </div>
...
//                 whileHover={{ y: -10 }}
//               >
//                 <Card className="p-6 h-full hover:shadow-xl transition-all duration-300 border-2 border-transparent hover:border-[#2563EB]/20 group cursor-pointer relative overflow-hidden">
...
//                 className="bg-gradient-to-r from-[#2563EB] to-[#1E3A8A]"
//               >
//                 Read About COSYNTRA
...
//                 <Button
//                   onClick={() => onNavigate('contact')}
//                   className="bg-white border-2 border-white text-black hover:bg-white/10"
//                 >
//                   Start Your Project
//                   <ArrowRight className="w-4 h-4 ml-2" />
//                 </Button>
...
//                   onClick={() => onNavigate('portfolio')}
//                   variant="outline"
//                   className="border-2 border-white text-black hover:bg-white/10"
//                 >
//                   View Our Work
//                 </Button>
//               </div>
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden bg-gradient-to-br from-[#F9FAFB] via-white to-[#F9FAFB]">
        ...
        >
          <source src="/BBBBB.mp4" type="video/mp4" />
        </video>
